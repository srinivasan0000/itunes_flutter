...
//I am barelly used this in assesment, but it wil be usefull for complex apps 
class TSizeUtils {
  TSizeUtils._();
  ...
  static double aHPercentWithAppBar(double percent,
  ...
  static double aHPercentWithSliverAppBar(double percent,
